...
void main(void) 
{  
    vec3 viewDir  = normalize( fs_in_TangentviewPos - fs_in_TangentFragPos);
    vec2 texCoords = ParallaxMapping( fs_in_TexCoords, viewDir );
    //vec2 texCoords = fs_in_TexCoords;
    ...
    color = CalcPointLight(pt_light, normal, fs_in_TangentFragPos, viewDir, texCoords);
}