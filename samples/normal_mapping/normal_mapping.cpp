...
int main(int argc, char const *argv[])
{
    ...
    if(argc < 3){
        std::cout<<"Usage Exe <Diffuse> <Normal>"<<std::endl;
        return 0;
    }
...
glcore::load_context(glfwGetProcAddress);
#endif
    {
        ...
        auto srt = SRT{ glm::vec3{2, 2, 2}, glm::vec3{glm::radians(-30.0f), 0, 0}, glm::vec3{0, 0, 0} };
        ...
        auto shader = glcore::Shader{vert_header + read_file("shaders/normal_mapping/normal_es.vert"), frag_header + read_file("shaders/normal_mapping/normal_es.frag")};
