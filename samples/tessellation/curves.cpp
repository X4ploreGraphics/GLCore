...
glcore::load_context(glfwGetProcAddress);
#endif
    {
        ...
        auto index = std::make_shared<glcore::Buffer>();
        index->write_data(indices);
        ...
        auto vert = utils::reader::read_binary("shaders/curves.vert");
        auto frag = utils::reader::read_binary("shaders/curves.frag");
        auto tesc = utils::reader::read_binary("shaders/curves.tesc");
        auto tese = utils::reader::read_binary("shaders/curves.tese");
